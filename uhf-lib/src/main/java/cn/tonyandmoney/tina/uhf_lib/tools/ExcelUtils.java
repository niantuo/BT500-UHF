package cn.tonyandmoney.tina.uhf_lib.tools;
...
public class ExcelUtils {
    ...
    private final static String[] mContent = new String[]{"ID", "EPC", "PC",
            UHFLib.getResources().getString(R.string.real_list_times),
            "RSSI", UHFLib.getResources().getString(R.string.real_list_freq),
            UHFLib.getResources().getString(R.string.tag_inventory_time)};

    private final static String[] mOperateData = new String[]{
            "ID", "PC", "CRC", "EPC", UHFLib.getResources().getString(R.string.data),
            UHFLib.getResources().getString(R.string.data_length),
            UHFLib.getResources().getString(R.string.list_antenna_port),
            UHFLib.getResources().getString(R.string.access_list_times)
    };
