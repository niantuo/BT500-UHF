package cn.tonyandmoney.tina.uhf_lib.base;


import cn.tonyandmoney.tina.uhf_lib.R;
...
public class CMD {
    ...
    public static String format(byte btCmd) {
        ...
        switch (btCmd) {
            case RESET:
                strCmd = UHFLib.getResources().getString(R.string.reset);
                break;
            case SET_UART_BAUDRATE:
                strCmd = UHFLib.getResources().getString(R.string.set_uart_baudrate);
                break;
            case GET_FIRMWARE_VERSION:
                strCmd = UHFLib.getResources().getString(R.string.get_firmware_version);
                break;
            case SET_READER_ADDRESS:
                strCmd = UHFLib.getResources().getString(R.string.set_reader_add);
                break;
            case SET_WORK_ANTENNA:
                strCmd = UHFLib.getResources().getString(R.string.set_work_ant);
                break;
            case GET_WORK_ANTENNA:
                strCmd = UHFLib.getResources().getString(R.string.get_work_ant);
                break;
            case SET_OUTPUT_POWER:
                strCmd = UHFLib.getResources().getString(R.string.set_output_power);
                break;
            case GET_OUTPUT_POWER:
                strCmd = UHFLib.getResources().getString(R.string.get_output_power);
                break;
            case SET_FREQUENCY_REGION:
                strCmd = UHFLib.getResources().getString(R.string.set_freq_reg);
                break;
            case GET_FREQUENCY_REGION:
                strCmd = UHFLib.getResources().getString(R.string.get_freq_reg);
                break;
            case SET_BEEPER_MODE:
                strCmd = UHFLib.getResources().getString(R.string.set_beeper_mode);
                break;
            case GET_READER_TEMPERATURE:
                strCmd = UHFLib.getResources().getString(R.string.get_rader_temp);
                break;
            case READ_GPIO_VALUE:
                strCmd = UHFLib.getResources().getString(R.string.read_gpio_value);
                break;
            case WRITE_GPIO_VALUE:
                strCmd = UHFLib.getResources().getString(R.string.write_gpio_value);
                break;
            case SET_ANT_CONNECTION_DETECTOR:
                strCmd = UHFLib.getResources().getString(R.string.set_ant_conn);
                break;
            case GET_ANT_CONNECTION_DETECTOR:
                strCmd = UHFLib.getResources().getString(R.string.get_ant_conn);
                break;
            case SET_TEMPORARY_OUTPUT_POWER:
                strCmd = UHFLib.getResources().getString(R.string.set_temp_output_power);
                break;
            case SET_READER_IDENTIFIER:
                strCmd = UHFLib.getResources().getString(R.string.set_reader_identi);
                break;
            case GET_READER_IDENTIFIER:
                strCmd = UHFLib.getResources().getString(R.string.get_reader_identi);
                break;
            case SET_RF_LINK_PROFILE:
                strCmd = UHFLib.getResources().getString(R.string.set_rf_link_pro);
                break;
            case GET_RF_LINK_PROFILE:
                strCmd = UHFLib.getResources().getString(R.string.get_rf_link_pro);
                break;
            case GET_RF_PORT_RETURN_LOSS:
                strCmd = UHFLib.getResources().getString(R.string.get_rf_port);
                break;
            case INVENTORY:
                strCmd = UHFLib.getResources().getString(R.string.inventory);
                break;
            case READ_TAG:
                strCmd = UHFLib.getResources().getString(R.string.read_tag_c);
                break;
            case WRITE_TAG:
                strCmd = UHFLib.getResources().getString(R.string.write_tag_c);
                break;
            case LOCK_TAG:
                strCmd = UHFLib.getResources().getString(R.string.lock_tag_c);
                break;
            case KILL_TAG:
                strCmd = UHFLib.getResources().getString(R.string.kill_tag_c);
                break;
            case SET_ACCESS_EPC_MATCH:
                strCmd = UHFLib.getResources().getString(R.string.set_access_epc_match);
                break;
            case GET_ACCESS_EPC_MATCH:
                strCmd = UHFLib.getResources().getString(R.string.get_access_epc_match);
                break;
            case REAL_TIME_INVENTORY:
                strCmd = UHFLib.getResources().getString(R.string.real_time_inventory);
                break;
            case FAST_SWITCH_ANT_INVENTORY:
                strCmd = UHFLib.getResources().getString(R.string.fast_switch_ant_inv);
                break;
            case CUSTOMIZED_SESSION_TARGET_INVENTORY:
                strCmd = UHFLib.getResources().getString(R.string.customized_session);
                break;
            case SET_IMPINJ_FAST_TID:
                strCmd = UHFLib.getResources().getString(R.string.set_impinj);
                break;
            case SET_AND_SAVE_IMPINJ_FAST_TID:
                strCmd = UHFLib.getResources().getString(R.string.set_and_save_impinj);
                break;
            case GET_IMPINJ_FAST_TID:
                strCmd = UHFLib.getResources().getString(R.string.get_imping);
                break;
            case ISO18000_6B_INVENTORY:
                strCmd = UHFLib.getResources().getString(R.string.iso_B_inv);
                break;
            case ISO18000_6B_READ_TAG:
                strCmd = UHFLib.getResources().getString(R.string.iso_B_read);
                break;
            case ISO18000_6B_WRITE_TAG:
                strCmd = UHFLib.getResources().getString(R.string.iso_b_write_tag);
                break;
            case ISO18000_6B_LOCK_TAG:
                strCmd = UHFLib.getResources().getString(R.string.iso_b_lock_tag);
                break;
            case ISO18000_6B_QUERY_LOCK_TAG:
                strCmd = UHFLib.getResources().getString(R.string.iso_b_query_lock_tag);
                break;
            case GET_INVENTORY_BUFFER:
                strCmd = UHFLib.getResources().getString(R.string.get_inventory_buff);
                break;
            case GET_AND_RESET_INVENTORY_BUFFER:
                strCmd = UHFLib.getResources().getString(R.string.get_ant_reset_inv);
                break;
            case GET_INVENTORY_BUFFER_TAG_COUNT:
                strCmd = UHFLib.getResources().getString(R.string.get_inventory_buffer_tag_count);
                break;
            case RESET_INVENTORY_BUFFER:
                strCmd = UHFLib.getResources().getString(R.string.reset_inventory_buff);
                break;
            default:
                strCmd = UHFLib.getResources().getString(R.string.unknown_operate);
                break;
        }
        return strCmd;
    }
